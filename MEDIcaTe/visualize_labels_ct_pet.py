...
def control_nii_orientation(nii_1,nii_2):
    print('before \n', (nii_1.affine))
    print('before \n', (nii_2.affine))
    print('before \n', nib.orientations.aff2axcodes(nii_1.affine))
    if not nib.orientations.aff2axcodes(nii_1.affine) == nib.orientations.aff2axcodes(nii_2.affine):
        print('orientation not equal')
        if not (nii_1.affine[:,0].any() != nii_2.affine[:,0].any()):
            print('axis 1 not equal')
            nii_1 = nii_1.slicer[::-1]
        if not (nii_1.affine[:,1].any() == nii_2.affine[:,1].any()):
            print('axis 2 not equal')
            nii_1 = nii_1.slicer[::-2]
        if not (nii_1.affine[:,2].any() == nii_2.affine[:,2].any()): 
            print('axis 3 not equal')   
            nii_1 = nii_1.slicer[::-3]
    print('after \n', (nii_1.affine))
    print('after \n', nib.orientations.aff2axcodes(nii_1.affine)) 
...
def stack_images_labels(z,nii_ct=None,nii_pet=None,label1=None,label2=None,label3=None):
    '''
    ...
    if (nii_ct and nii_pet) is not None: 
        
        
        
        ################# create ct image ########################
        img_ct = nii_ct.dataobj[..., z]
    ...
    elif nii_ct is not None:
        
       
        ################# create pet image ##############################
        img_ct = nii_ct.dataobj[..., z]
        # set window of pet image
        img_ct=window_image(img_ct, 0.1, 7)
        img_ct = ndimage.rotate(img_ct, 90, reshape=False)#rotate
        axs.imshow(img_ct, cmap='gray',alpha=0.5)
    ...
    elif (nii_pet and nii_ct) is None:
...
def visualization(final_path,ct_path=None,pet_path=None,label1_path=None,label2_path=None,slice_range=None,font=None,crop_image=None):
    #checking input
    ...
    if ct_path is not None:
        nii_img_ct=nib.load(ct_path)
    if pet_path is not None:
        nii_img_pet=nib.load(pet_path)
    if label1_path is not None:
        nii_img_l1=nib.load(label1_path)
    if label2_path is not None:
        nii_img_l2=nib.load(label1_path)

    if slice_range is None:
        if ct_path is not None:
            [x,y,z]=nii_img_ct.shape
            slice_range=list(range(0, z))
        elif pet_path is not None:
            [x,y,z]=nii_img_pet.shape
            slice_range=list(range(0, z))
        elif label1_path is not None:
            [x,y,z]=nii_img_l1.shape
            slice_range=list(range(0, z))
        elif label2_path is not None:
            [x,y,z]=nii_img_l2.shape
            slice_range=list(range(0, z))
    ...
    if ct_path is not None:
        if pet_path is not None:
            [nii_img_ct,nii_img_pet]=control_nii_orientation(nii_img_ct,nii_img_pet)
        elif label1_path is not None:
            [nii_img_ct,nii_img_l1]=control_nii_orientation(nii_img_ct,nii_img_l1)
        elif label2_path is not None:
            [nii_img_ct,nii_img_l2]=control_nii_orientation(nii_img_ct,nii_img_l2)
    ...
    if (label1_path and label2_path and ct_path and pet_path) is not None: 
        ...
        for z in slice_range: 
            ...
            if exist_l1==True or exist_l2==True:
                if exist_l1==True and exist_l2==False:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,nii_pet=nii_img_pet,label1=a1)
                    saving_figure(fig,img_f_path,filename,z)
                elif exist_l1==False and exist_l2==True:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,nii_pet=nii_img_pet,label2=a2)
                    saving_figure(fig,img_f_path,filename,z)
                else:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,nii_pet=nii_img_pet,label1=a1,label2=a2,label3=a3)
                    saving_figure(fig,img_f_path,filename,z)
            else:
                z+=1
        ...
        for z in slice_range: 
            ...
            if exist_l1==True or exist_l2==True:
                if exist_l1==True and exist_l2==False:
                    fig=stack_images_labels(z,nii_pet=nii_img_pet,label1=a1)
                    saving_figure(fig,img_f_path,filename,z)
                elif exist_l1==False and exist_l2==True:
                    fig=stack_images_labels(z,nii_pet=nii_img_pet,label2=a2)
                    saving_figure(fig,img_f_path,filename,z)
                else:
                    fig=stack_images_labels(z,nii_pet=nii_img_pet,label1=a1,label2=a2,label3=a3)
                    saving_figure(fig,img_f_path,filename,z)
            else:
                z+=1
        ...
        for z in slice_range: 
            ...
            if exist_l1==True or exist_l2==True:
                if exist_l1==True and exist_l2==False:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,label1=a1)
                    saving_figure(fig,img_f_path,filename,z)
                elif exist_l1==False and exist_l2==True:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,label2=a2)
                    saving_figure(fig,img_f_path,filename,z)
                else:
                    fig=stack_images_labels(z,nii_ct=nii_img_ct,label1=a1,label2=a2,label3=a3)
                    saving_figure(fig,img_f_path,filename,z)
            else:
                z+=1
    elif (((label1_path and label2_path) is not None) and ((pet_path and ct_path) is None)):
        for z in slice_range: 
            print(f'//////////////////  slice {z} ////////////////////////')
            ...
            if exist_l1==True or exist_l2==True:
                if exist_l1==True and exist_l2==False:
                    fig=stack_images_labels(z,label1=a1)
                    saving_figure(fig,img_f_path,filename,z)
                elif exist_l1==False and exist_l2==True:
                    fig=stack_images_labels(z,label2=a2)
                    saving_figure(fig,img_f_path,filename,z)
                else:
                    fig=stack_images_labels(z,label1=a1,label2=a2,label3=a3)
                    saving_figure(fig,img_f_path,filename,z)
            else:
                z+=1              
    else:
        ...
        for z in slice_range: 
            ...
            fig=stack_images_labels(z,nii_ct=nii_img_ct,nii_pet=nii_img_pet)
            saving_figure(fig,img_f_path,filename,z)
    ...
    if crop_image is True:
        image_crop_path=join(temp_path,'cropped')
...
if __name__ == '__main__':
    ...
    ct='/home/fmik/data/MD_answers/t_l64/images/HNC03_028_0000.nii.gz'
    pet='/home/fmik/data/MD_answers/t_l64/images/HNC03_028_0001.nii.gz'
    l1='/home/fmik/data/MD_answers/t_l64/labels/md/HNC03_028_md.nii.gz'
    l2='/home/fmik/data/MD_answers/t_l64/labels/ref/HNC03_028_ref.nii.gz'
    z_list=list(range(90, 95))

    font = ImageFont.truetype('/home/fmik/data/AdventPro-ExtraLight.ttf',size=52)
             
    visualization(final_path,ct_path=ct,pet_path=pet,label1_path=l1,label2_path=l2,slice_range=z_list,font=font,crop_image=True)

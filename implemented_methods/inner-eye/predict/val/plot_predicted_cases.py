...
predicted_labels = '/homes/kovacs/project_data/hnc-auto-contouring/inner-eye/output/majority_voted'
final_path = '/homes/kovacs/project_data/hnc-auto-contouring/inner-eye/output/majority_voted_plots'
...
def plot_swin_unetr(case):
    ...
    visualization(final_path=final_path_case,ct_path=ct_path,pet_path=pt_path,
                  l1_path=gt_label_path,l2_path=pred_label_path,l3_path=None,
                  verbose=True)

if __name__ == '__main__':
    data_inputs = listdir(predicted_labels)
    data_inputs = ['HNC01_029.nii.gz']#[0:10]#data_inputs

...
if __name__ == '__main__':
    predicted_nn_unet = ('/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/predictions_nnunet/labels_nn_unet_ensemble_final')

    path_folder_ground_truth = ('/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/labels')
    ...
    #list_of_cases_nn_unet = [item for item in list_of_cases_nn_unet if (item != ('HNC05_000.nii.gz'))] # remove incomplete test-case
    #list_of_cases_nn_unet = [item for item in list_of_cases_nn_unet if (item != ('HNC05_001.nii.gz'))] # remove incomplete test-case
    list_of_cases_nn_unet = [case for case in list_of_cases_nn_unet if
                             case.endswith(('HNC05_001.nii.gz'))]
    ...
    d_metrics.to_csv(join(result_dest, 'metrics_test125_hnc05_001.csv'), index=False)

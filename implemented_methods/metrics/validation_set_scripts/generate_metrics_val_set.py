...
result_file_deep_medic = '/homes/kovacs/project_scripts/hnc_segmentation/MEDIcaTe/implemented_methods/deepMedic/predict/val/dice_haus_mAll_f0.csv'
...
result_file_swin_unetr = '/homes/kovacs/project_scripts/hnc_segmentation/MEDIcaTe/implemented_methods/swin-unetr/predict/dice_haus_mAll_f0.csv'
...
r_out.to_csv('/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_final_results/metrics_val_set_f0.csv')

...
export FOLDER_WITH_TEST_CASES=/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/images
export OUTPUT_FOLDER_MODEL1=/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/predictions_nnunet/labels_nn_unet_m1
export OUTPUT_FOLDER_MODEL2=/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/predictions_nnunet/labels_nn_unet_m2
export OUTPUT_FOLDER=/homes/kovacs/project_data/hnc-auto-contouring/hnc_hgh_all/data_nifti/predictions_nnunet/labels_nn_unet_ensemble_final

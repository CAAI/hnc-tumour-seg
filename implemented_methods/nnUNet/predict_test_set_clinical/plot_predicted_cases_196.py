...
def plot_preds(case):
    ...
    final_path_case = join(final_path, case[:-7]+'_FIG2_zoom')
    ...
    visualization(final_path=final_path_case+'empty',ct_path=ct_path,pet_path=pt_path,
                  ...
                  slices=None, cropping=False, all_slices=True, # for slices to do a specific do: 
    ...
    visualization(final_path=final_path_case+'_ref',ct_path=ct_path,pet_path=pt_path,
                  ...
                  l3_path= None, #md_label_path, # md_label_path, # md_label_path, 
                  l3_name= None, #'phys. eva',#'eval. expert', # 'phys. eva',
                  slices=None, cropping=False, all_slices=False, # for slices to do a specific do: 
    ...
    visualization(final_path=final_path_case+'ref_AI_full',ct_path=ct_path,pet_path=pt_path,
                l1_path= gt_label_path, #,gt_label_path,
                l1_name= 'ref. expert', #'ref. expert'
                l2_path= pred_label_path, #pred_label_path, # 
                l2_name= 'AI', #'AI', # 
                l3_path= None, #md_label_path, # md_label_path, # md_label_path, 
                l3_name= None, #'phys. eva',#'eval. expert', # 'phys. eva',
                slices=[78,99,109,111,113,119,125,128,137,141,145,151], cropping=True, all_slices=False, # for slices to do a specific do: [78,99,109,111,113,119,125,128,137,141,145,151] apex = 227
                incl_info=True,outline=False,verbose=True)
...
if __name__ == '__main__':
    ...
    final_path = '/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_r196/figs'

    data_inputs = ['HNC02_128.nii.gz']  # listdir(predicted_labels) #, 'HNC03_043.nii.gz'

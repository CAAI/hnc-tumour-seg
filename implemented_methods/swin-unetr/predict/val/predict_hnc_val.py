...
parser.add_argument('--exp_name', default='test_hnc0', type=str, help='experiment name') # DGK SET
parser.add_argument('--json_list', default='dataset_1.json', type=str, help='dataset json file') # DGK SET
parser.add_argument('--pretrained_model_name', default='best_metric_model.pth', type=str, help='pretrained model name') # DGK SET

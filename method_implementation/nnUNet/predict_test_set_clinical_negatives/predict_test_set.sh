...
export FOLDER_WITH_TEST_CASES=/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_n13/images
export OUTPUT_FOLDER_MODEL1=/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_n13/predictions_nnunet/labels_nn_unet_m1
export OUTPUT_FOLDER_MODEL2=/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_n13/predictions_nnunet/labels_nn_unet_m2
export OUTPUT_FOLDER=/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_n13/predictions_nnunet/labels_nn_unet_ensemble_final

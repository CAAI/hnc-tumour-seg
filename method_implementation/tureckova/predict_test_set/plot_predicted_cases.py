...
if __name__ == '__main__':
    ...
    predicted_labels = '/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_r196/predictions/tureckova/vnet1_lowres_timed'
    final_path = '/homes/kovacs/project_data/hnc-auto-contouring/hnc_rigs_all/data_nifty/t_r196/predictions/figs/tureckova'

    data_inputs = ['HNC02_035.nii.gz'] # listdir(predicted_labels)
